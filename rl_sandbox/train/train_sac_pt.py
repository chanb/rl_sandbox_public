...
from rl_sandbox.algorithms.sac.sac_pt import SACPT
...
def train_sac_pt(experiment_config):
    ...
    learning_algorithm = SACPT(model=model,
    ...
    summary_writer, save_path = make_summary_writer(save_path=save_path, algo=c.SAC_PT, cfg=experiment_config)
    train(agent=agent,
