...
from rl_sandbox.constants import OBS_RMS, CPU, SPECTRAL
from rl_sandbox.model_architectures.actor_critics.actor_critic import SquashedGaussianSoftActorCritic
from rl_sandbox.model_architectures.shared import Conv2DEncoder, Flatten, Fuse, Split, ModernBlock
...
class EarlyFusionConv2DGaussianSAC(SquashedGaussianSoftActorCritic):
    def __init__(self,
        ...
        self.fuse = Fuse()
        self.encoder = Conv2DEncoder(*img_dim[1:], shared_out_dim, shared_layers, nn.LayerNorm(shared_out_dim))
...
class EarlyFusionConv2DSpectralNormGaussianSAC(SquashedGaussianSoftActorCritic):
    def __init__(self,
                 img_dim,
                 scalar_feature_dim,
                 action_dim,
        ...
        encoded_dim = shared_out_dim * self._img_dim[0] + scalar_feature_dim
        self._policy = nn.Sequential(nn.Linear(encoded_dim, 1024),
                                     nn.LayerNorm(1024),
