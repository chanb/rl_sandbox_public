...
from rl_sandbox.train.train_sac_drq import train_sac_drq
...
experiment_setting = {
    ...
    c.TAU: 0.005,
    c.TRAIN_PREPROCESSING: gt.Compose([it.RandomCrop(raw_img_dim, height=processed_h, width=processed_w), gt.Normalize(mean=0., var=255.)]),
    c.UPDATE_NUM: 0,
    ...
    # Save
    c.SAVE_PATH: f"../results/dm_control/reacher/easy/image-sac-drq/curl_encoder/{seed}",
...
train_sac_drq(experiment_config=experiment_setting)
