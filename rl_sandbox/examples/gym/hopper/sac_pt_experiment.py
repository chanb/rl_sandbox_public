...
from rl_sandbox.buffers.wrappers.prioritized_experience_replay import PrioritizedExperienceReplay
...
from rl_sandbox.train.train_sac_pt import train_sac_pt
...
experiment_setting = {
    ...
    c.BUFFER_SETTING: {
        ...
        c.BUFFER_WRAPPERS: [
            {
                c.WRAPPER: PrioritizedExperienceReplay,
                c.KWARGS:{
                    c.PER_ALPHA: 0.2,
                    c.PER_BETA: 0.2,
                    c.PER_BETA_INCREMENT: 0.0,
                    c.PER_EPSILON: 1e-5,
                },
            },
            {
                c.WRAPPER: TorchPrioritizedExperienceReplay,
                c.KWARGS: {},
            },
        ],
    },
    ...
    # Save
    c.SAVE_PATH: f"../results/mujoco/hopper-v2/pt-gt-sac-separate-og_params/{seed}",
...
train_sac_pt(experiment_config=experiment_setting)
