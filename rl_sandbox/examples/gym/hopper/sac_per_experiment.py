...
from rl_sandbox.train.train_sac_per import train_sac_per
...
experiment_setting = {
    ...
    # Save
    c.SAVE_PATH: f"../results/mujoco/hopper-v2/per-gt-sac-separate-og_params/{seed}",
...
train_sac_per(experiment_config=experiment_setting)
